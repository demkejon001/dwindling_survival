...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            //Debug.Log(Time.deltaTime * warmthDecrementRate * gameManager.GameCycle());
            warmth = Mathf.Max(warmth - Time.deltaTime * warmthDecrementRate * (1-gameManager.GameCycle()), 0);
        }
